...
public class SortMergeOperator extends JoinOperator {
     ...
     *
     * We pass the results of SortOperator into SortMergeOperator as sorted unjoined tables!!
     *
            ...
            while (leftRecord != null && rightRecord != null) {
                ...
                if (compare(leftRecord, rightRecord) == 0) {
                    ...
                    if (rightIterator.hasNext()) {
                        ...
                        // if we don't have next right record to compare,
                        // get this left one done and start the next round for next left record
                        rightIterator.reset();
                        rightRecord = rightIterator.next();
