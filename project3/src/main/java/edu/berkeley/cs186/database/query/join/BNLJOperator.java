        ...
        private void fetchNextLeftBlock() {
            if (this.leftSourceIterator.hasNext()) {
                this.leftBlockIterator =
                        getBlockIterator(this.leftSourceIterator, getLeftSource().getSchema(), numBuffers - 2);
        ...
        private void fetchNextRightPage() {
            if (this.rightSourceIterator.hasNext()) {
                this.rightPageIterator =
                        getBlockIterator(this.rightSourceIterator, getRightSource().getSchema(), 1);
        ...
        private Record fetchNextRecord() {
            while (true) {
                if (this.leftRecord == null) {
                    fetchNextLeftBlock();
                    if (this.leftRecord == null || !this.leftSourceIterator.hasNext()) {
                        return null;
                    }
                }
                if (this.rightPageIterator.hasNext()) {
                    ...
                    leftRecord = leftBlockIterator.next();//updating leftRecord after resetting the iterator
